...
class InstaBot:
    ...
    def logout(self):
        ...
        self.write_log(log_string)
        work_time_h = datetime.datetime.now().hour - self.bot_start.hour
        work_time_m = datetime.datetime.now().minute - self.bot_start.minute
        mins=work_time_h*60+work_time_m
        log_string = 'Bot work time: %s minutes' % (mins)
        self.write_log(log_string)
        #file handling
